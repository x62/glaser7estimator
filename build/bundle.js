var app = (function () {
    ...
    /* src\Form.svelte generated by Svelte v3.24.0 */
    ...
    /* src\Table.svelte generated by Svelte v3.24.0 */
    ...
    // (51:4) {#each materials as material (material.id)}
    function create_each_block(key_1, ctx) {
    	...
    	let t1;
    	let td1;
    	let t2_value = /*formatter*/ ctx[3].format(/*material*/ ctx[6].price) + "";
    	let t2;
    	let t3;
    	let td2;
    	let i;
    	...
    	return {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen(tr, "click", function () {
    						if (is_function(/*edit*/ ctx[2](/*material*/ ctx[6].id, /*material*/ ctx[6].name, /*material*/ ctx[6].price))) /*edit*/ ctx[2](/*material*/ ctx[6].id, /*material*/ ctx[6].name, /*material*/ ctx[6].price).apply(this, arguments);
    					})
    				];
    		...
    		p(new_ctx, dirty) {
    			...
    			if (dirty & /*materials*/ 1 && t2_value !== (t2_value = /*formatter*/ ctx[3].format(/*material*/ ctx[6].price) + "")) set_data(t2, t2_value);
    		},
    		d(detaching) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [materials, total, edit, formatter, remove];
    }
